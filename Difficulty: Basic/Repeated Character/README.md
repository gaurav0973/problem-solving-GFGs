<h2><a href="https://www.geeksforgeeks.org/problems/repeated-character2058/1?page=1&category=Hash&difficulty=Basic&status=unsolved&sortBy=submissions">Repeated Character</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string consisting of lowercase english alphabets. Find the repeated character present <strong>first</strong> in the string.</span></p>
